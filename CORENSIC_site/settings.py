"""
Django settings for CORENSIC_site project.
...
INSTALLED_APPS = [
    ...
    'CORENSIC_site_app.apps.CorensicSiteAppConfig',
]
...
ROOT_URLCONF = 'CORENSIC_site.urls'
...
WSGI_APPLICATION = 'CORENSIC_site.wsgi.application'
